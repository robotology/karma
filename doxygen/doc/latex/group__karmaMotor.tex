\doxysection{Motor Part of the KARMA Experiment}
...
Assume that i\+Cub\+Interface (with ICartesian\+Control interface implemented) is running.\hypertarget{group__karmaToolProjection_portsc_sec}{}\doxysubsection{Ports Created}\label{group__karmaToolProjection_portsc_sec}
